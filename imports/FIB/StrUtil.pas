...
function FastUpperCase(const S: string): string; {$IFDEF D11+} inline;{$ENDIF}
...
function FormatIdentifierValue(Dialect: Integer; const Value: string): string;{$IFDEF D11+} inline;{$ENDIF}
function FormatIdentifier(Dialect: Integer; const Value: String): String;{$IFDEF D11+} inline;{$ENDIF}
function NormalizeName(Dialect: Integer; const Name: String): String;{$IFDEF D11+} inline;{$ENDIF}
function EasyFormatIdentifier(Dialect: Integer; const Value: String;DoEasy:boolean ): String;{$IFDEF D11+} inline;{$ENDIF}

function EquelNames(CI:boolean; const Value,Value1: String): boolean;{$IFDEF D11+} inline;{$ENDIF}
...
{$ENDIF}
function PosCI(const Substr,Str:string):integer;  {$IFDEF D11+} inline;{$ENDIF}
function PosExt(const Substr,Str:String;BegSub,EndSub:TCharSet):integer;{$IFDEF D12+} inline;{$ENDIF}
...
function InternalNeedQuote(const Name:String; Easy:boolean):boolean;{$IFDEF D11+} inline;{$ENDIF}
var
     I,L:integer;
     Ch1,Ch2:Char;
begin
