...
uses
  ...
  pFIBDataInfo,  {$IFDEF D6+}FMTBcd, Variants, {$ENDIF}  Windows,   Messages;
...
{$ENDIF}
    ...
    function IsVisible(Buffer: dbPChar): Boolean; override;
...
function TpFIBDataSet.IsVisible(Buffer: dbPChar): Boolean;
var
