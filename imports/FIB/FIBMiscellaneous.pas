  ...
  begin
   ...
   begin
     ...
     begin
      ...
      WriteFile(FHandle, L, SizeOf(L), BytesWritten, nil);
      if L>0 then
       WriteFile(FHandle, FCharset[1], L, BytesWritten, nil);
     end
   end;
   FState  :=bsFileReady
  end;
...
begin
  ...
  begin
   ...
   ReadFile(FHandle, ast[1], Length(SignRowFile), BytesRead, nil);
   ...
   begin
    ReadFile(FHandle, ast[1], 1, BytesRead, nil);
...
//Charset
      ...
      begin
       ...
       ReadFile(FHandle, FCharset[1], L, BytesRead, nil);
      end;
      FState  :=bsFileReady
     end;
    FState  :=bsFileReady
