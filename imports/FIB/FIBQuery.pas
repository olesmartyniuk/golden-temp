...
uses
  ...
  pFIBInterfaces, FIBMDTInterface,
        ...
        try
          ...
          begin
            ...
            begin
             ...
             SetLength(s, FStreamValue.Size);
             FStreamValue.Position:=0;
             FStreamValue.Read(s[1],FStreamValue.Size) ;
...
//  if not FParent.FQuery.Prepared then
  ...
  case vt of
   ...
   {$ENDIF}
    ...
    varOleStr{$IFDEF D12+},varUString{$ENDIF} :
       AsWideString := Value;
    varString:
      AsAnsiString := Value;
    varArray:
